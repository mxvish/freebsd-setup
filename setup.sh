...
pkg install -y btop cmatrix dmenu drm-kmod emacs-nox fastfetch git i3 i3lock i3status nasm qemu tree vim xf86-video-intel xf86-video-scfb xfce4-terminal xorg
