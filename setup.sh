...
pkg install -y cmatrix dmenu dmenu-wayland drm-kmod emacs-nox firefox git grim i3 i3lock i3status nasm neofetch qemu sway vim wayland xf86-video-intel xfce4-terminal xorg
