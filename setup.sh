...
pkg install -y btop cmatrix dmenu drm-kmod emacs-nox fastfetch fcitx5 fcitx5-configtool fcitx5-gtk3 firefox git i3 i3lock i3status ja-fcitx5-skk ja-font-ipa nasm neovim py312-ranger qemu tree vim xf86-video-intel xf86-video-scfb xclip xfce4-terminal xorg
